...
AutomatedEmail(Attendee, '{EVENT_NAME} Check-in Barcode',
...
AutomatedEmail(Room, '{EVENT_NAME} Hotel Room Assignment Update',
               'hotel/room_assignment_update.txt', lambda r: r.locked_in,
